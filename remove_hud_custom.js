...
client.once(Events.ClientReady, async () => {
  console.log(`🤖 Logged in as ${client.user.tag}! Gỡ bỏ HUD custom...`);
  ...
  try {
        ...
        .addFields(
          ...
          },
          {
            ...
            value: 
              ...
              "• **Nhận làm:** Custom Items, Vũ khí, Giáp, Khối Block, Sinh vật (Mobs/Boss), Custom GUI, Mod cơ chế gameplay độc quyền.\n" +
        ...
        .addFields(
          ...
          },
          {
            ...
            value: 
              ...
              "• **Hạng mục:** Custom Item, Giáp, Mobs, Block, GUI, Gameplay mới\n" +
    ...
    console.log("🎉 ĐÃ GỠ BỎ HUD CUSTOM XONG 100%!");
    clearTimeout(watchdog);
    try {
      await client.destroy();
    } catch {}
