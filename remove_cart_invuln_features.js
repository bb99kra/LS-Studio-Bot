...
client.once(Events.ClientReady, async () => {
  console.log(`🤖 Logged in as ${client.user.tag}! Cập nhật bỏ tính năng bất tử & packet lag khỏi Anti-Macro Cart...`);
  ...
  try {
    ...
    await refreshChannel(chAc, async (ch) => {
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          ...
          "• **Addon Anti-Macro Cart:** `20.000 VNĐ / Tháng` • Gói bảo vệ xe mỏ và thuyền\n" +
          ...
          "• **Chặn Macro Tốc Độ Xe Mỏ & Thuyền:** Chặn đứng hack/macro lợi dụng Minecart và Thuyền (Boat) để di chuyển với tốc độ bất thường xuyên địa hình.\n\n" +
          "────────────────────────────────────────\n" +
          "🇺🇸 **ENGLISH:**\n" +
          ...
          "• **Anti-Macro Cart Addon:** Blocks Minecart and Boat macro speed exploits across terrains."
        )
    ...
    // 2. CẬP NHẬT KÊNH #🚀・cập-nhật-changelog
    ...
    await refreshChannel(chLogs, async (ch) => {
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          ...
          "  - Chặn đứng hack/macro lợi dụng Minecart và Thuyền (Boat) để di chuyển với tốc độ bất thường xuyên địa hình.\n" +
          ...
          "✨ **What's New:**\n" +
          "• 🚂 **Anti-Macro Cart Addon Release ($1.00/Month):** Complete protection against Minecart/Boat macro speed exploits across terrains.\n" +
    ...
    console.log("🎉 ĐÃ CẬP NHẬT GỠ BỎ TÍNH NĂNG BẤT TỬ & PACKET KHỎI CHANNELS XONG 100%!");
    clearTimeout(watchdog);
    try {
      await client.destroy();
    } catch {}
