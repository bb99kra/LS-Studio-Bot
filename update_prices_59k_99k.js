...
client.once(Events.ClientReady, async () => {
  console.log(`🤖 Logged in as ${client.user.tag}! Cập nhật giá AntiFreecam 59k & AntiClient 99k...`);
  ...
  try {
        ...
        .addFields(
          ...
          },
          {
            ...
            value: 
              ...
              "• **Hỗ trợ:** Paper / Purpur / Folia (1.16 - 1.21+)\n" +
              "• **Giá Combo:** `129.000 VNĐ` *(Tiết kiệm 29k)*"
          },
          {
    ...
    console.log("🎉 ĐÃ CẬP NHẬT GIÁ MỚI XONG 100%!");
    await cleanupAndExit(0);
  } catch (err) {
