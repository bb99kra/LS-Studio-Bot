...
client.once(Events.ClientReady, async () => {
  console.log(`🤖 Logged in as ${client.user.tag}! Thêm Dịch Vụ Mod Custom (Chỉ Java)...`);
  ...
  try {
        ...
        .addFields(
          ...
          },
          {
            ...
            value: 
              ...
              "• **Nhận làm:** Custom Items, Vũ khí, Giáp, Khối Block, Sinh vật (Mobs/Boss), Custom GUI/HUD, Mod cơ chế gameplay độc quyền.\n" +
        ...
        .addFields(
          ...
          },
          {
            ...
            value: 
              ...
              "• **Hạng mục:** Custom Item, Giáp, Mobs, Block, GUI, HUD, Gameplay mới\n" +
    ...
    await refreshChannel(channels.get("1542479120036794418"), async (ch) => {
      const embed = new EmbedBuilder()
        ...
        .setDescription(
          ...
          "• 🛡️ Plugin chống hack: Chống Freecam, chống X-Ray/ESP, chặn Hack Client (Meteor, Liquid...).\n" +
          "• 🎁 Plugin tiện ích: Hệ thống Giftcode, Economy, Custom Items.\n" +
          "• 🧩 **Nhận Code MOD Custom (Forge / Fabric / NeoForge)**: Custom vũ khí, quái vật, GUI, block mới cho Minecraft Java PC.\n" +
          "• ⚡ Nhận lập trình Plugin riêng theo ý tưởng & Tối ưu server Folia/Paper."
        )
        .addFields(
    ...
    console.log("🎉 ĐÃ CẬP NHẬT DỊCH VỤ MOD CUSTOM JAVA XONG 100%!");
    await cleanupAndExit(0);
  } catch (err) {
